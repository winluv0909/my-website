    ...
    <main className="font-sans text-gray-900 w-full overflow-hidden">
      ...
      <section className="relative overflow-hidden min-h-screen flex items-center justify-center px-6 bg-linear-to-br from-gray-50 via-white to-gray-100">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          {/* Grid Overlay */}
          <div className="absolute inset-0 opacity-[0.03] bg-[linear-gradient(to_right,#000_1px,transparent_1px),linear-gradient(to_bottom,#000_1px,transparent_1px)] background-size: 80px 80px;]"></div>
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          {/* Badge */}
          <FadeUp>
            <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-gray-300 bg-white/70 backdrop-blur-md shadow-sm">
          ...
          {/* Main Heading */}
          <FadeUp delay={0.1}>
            <h1 className="mt-10 text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight leading-tight">
              株式会社 大崎総業
            </h1>
          </FadeUp>
          ...
          {/* English Name */}
          <FadeUp delay={0.2}>
            <p className="mt-6 text-2xl md:text-3xl text-gray-600 font-light tracking-wide">
              Oosaki Sogyo Co., Ltd.
            </p>
          </FadeUp>
          ...
          {/* Description */}
          <FadeUp delay={0.3}>
            <p className="mt-8 max-w-3xl mx-auto text-lg md:text-xl text-gray-500 leading-relaxed">
              世界中の人々に日本での未来を。<br className="hidden md:block" />
              働き、成長し、ともに成功へ。
            </p>
          </FadeUp>
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-16">
            ...
            <FadeUp delay={0.1}>
              <div className="p-10 bg-white rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
