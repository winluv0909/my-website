...
export default function AboutPage() {
  ...
  useEffect(() => {
    ...
    elements.forEach((el, index) => {
      el.classList.remove("show"); // reset animation on page change
    ...
    <main className="bg-gray-50 text-gray-900">
      ...
      <section className="py-24 px-6 text-center fade-up">
        <div className="max-w-4xl mx-auto fade-up">
          <h1 className="text-5xl md:text-6xl font-bold tracking-tight fade-up">
            株式会社大崎総業について
          </h1>

          <p className="mt-6 text-xl text-gray-500 font-medium fade-up">
            私たちについて・企業理念
          </p>
        </div>
      </section>
...
/>
     ...
     {/* Name */}
          ...
          {/* CARD */}
          <div className="p-10 bg-white rounded-2xl shadow-sm border border-gray-200 hover:shadow-xl transition duration-300 fade-up">
            <h3 className="text-xl font-semibold">当社のミッション</h3>
            <p className="mt-4 text-gray-600">
              企業に効率的な人材ソリューションを提供し、安定した事業運営と生産性の向上に貢献します。
            </p>

            <h3 className="text-xl font-semibold mt-8">当社のビジョン</h3>
            <p className="mt-4 text-gray-600">
      ...
      <section className="py-28 px-6 text-center fade-up">
        <h2 className="text-3xl font-semibold tracking-tight fade-up">
          今、何をためらっていますか？ぜひ私たちと一緒に働きましょう！
        </h2>

        <p className="mt-6 text-gray-500 fade-up">
